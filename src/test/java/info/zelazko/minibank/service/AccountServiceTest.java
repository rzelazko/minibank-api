...
class AccountServiceTest {
    ...
    void getAccountNotFound() {
        ...
        // then
        assertEquals(MinibankError.ACCOUNT_NOT_FOUND.getCode(), exception.getCode());
    }
    ...
    void createAccountValidationException(String scenario, MinibankError error, Optional<Account> account, AccountPayload accountPayload) {
